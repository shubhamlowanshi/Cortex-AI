...
import { MessageSquare, User, PanelLeftIcon, PenBox, PenBoxIcon, PenSquare, Plus, Coins, LogOut, PanelRight } from "lucide-react"
    ...
    w-[270px] h-screen shrink-0 bg-[#0d0f14] border-r border-white/[0.06] '>
            <div
                ...
                {conversation.length == 0
                    ?
                    <div
                        className='px-5 pt-4 pb-1.5 text-[10.5px] font semi-bold uppercase tracking-widest text-slate-600  '>
                ...
                <div
                    className='flex-1 overflow-y-auto px-2.5 pb-2 [scrollbar-width:none] [&:: -webkit-scrollbar]:hidden '>
