  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        <div className="flex itmes-center gap-2.5 px-4 py-4 border-b border-white/[0.06]  ">
          <div
        ...
        {conversation.length == 0 ? (
          <div className="px-5 pt-4 pb-1.5 text-[10.5px] font semi-bold uppercase tracking-widest text-slate-600  ">
        ...
        <div className="flex-1 overflow-y-auto px-2.5 pb-2 [scrollbar-width:none] [&:: -webkit-scrollbar]:hidden ">
          {conversation.map((conv, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex items-center justify-center shrink-0 w-[28px] h-[28px] h-[28px] rounded-lg transition-colors duration-150
                        ${isActive ? "bg-indigo-150/15 text-indigo-400" : "bg-white/[0.05] text-slate-500 "} `}
                >
                  <MessageSquare size={13} />
                </div>
        ...
        <div className="mx-2.5 h-18  w-auto bg-white/[0.06]">
              ...
              <div className="flex items-center gap-2.5 cursor-pointer rounded-xl px-3 py-2.5  hover:bg-white/[0.05] transition-colors duration-150">
                ...
                <div className="flex gap-1">
                  <button
                    ...
                    className="flex items justify-center w-7 rounded-[7px] border-none bg-transparent text-yellow-600 cursor-pointer hover:bg-white/[0.08] hover:text-slate-400 transition-all duration-150 "
                  >
                    <Coins size={16} />
                  </button>
                  <button
